...
public class addCyclicalExpenses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_cyclical_expenses);
        setTitle(getResources().getString(R.string.str_dodaj_cykliczny_wydatek));
        ...
        if(editing)
        {
            ...
            posCategory = CategoryIdList.indexOf(database.getCyclicalExpensesCategory(idCyclicalExpenses));

            SubCategoryIdList = database.getIdListOfSubcategory(CategoryIdList.get(posCategory));



            posSubCategory = SubCategoryIdList.indexOf(database.getCyclicalIncomeSubcategory(idCyclicalExpenses));
            positionFREQUENCY = database.getCyclicalIncomeFrequency(idCyclicalExpenses);

            bufforName = database.getCyclicalExpensesName(idCyclicalExpenses);
            bufforAmount = Double.toString(database.getCyclicalIncomeAmount(idCyclicalExpenses));
            setTitle(getResources().getString(R.string.str_edycja_cyklicznego_wydatku));
            date1 = database.getCyclicalExpensesOD(idCyclicalExpenses);
            date2 = database.getCyclicalExpensesDO(idCyclicalExpenses);
            date3 = database.getCyclicalExpensesNastepnaData(idCyclicalExpenses);
        ...
        if(correct)
        {
            ...
            if(!editing)
            {
                switch (sprFreq.getSelectedItemPosition()) {
                    case 0:
                        database.addCyclicalExpenses(txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.DAILY);
                        Toast.makeText(this, getResources().getString(R.string.str_dodano_nowy_cykliczny_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;

                    case 1:
                        database.addCyclicalExpenses(txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.WEEKLY);
                        Toast.makeText(this, getResources().getString(R.string.str_dodano_nowy_cykliczny_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;

                    case 2:
                        database.addCyclicalExpenses(txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.MONTHLY);
                        Toast.makeText(this, getResources().getString(R.string.str_dodano_nowy_cykliczny_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;

                    case 3:
                        database.addCyclicalExpenses(txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.QUARTERLY);
                        Toast.makeText(this, getResources().getString(R.string.str_dodano_nowy_cykliczny_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;

                    case 4:
                        database.addCyclicalExpenses(txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.YEARLY);
                        Toast.makeText(this, getResources().getString(R.string.str_dodano_nowy_cykliczny_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        Toast.makeText(this, getResources().getString(R.string.str_blad_dodawania_cykl_wyd), Toast.LENGTH_LONG);
                        break;
                }
            }
            else
            {
                switch (sprFreq.getSelectedItemPosition()) {
                    case 0:
                        database.UpdateCyclicalExpenses(idCyclicalExpenses, txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.DAILY);
                        Toast.makeText(this, getResources().getString(R.string.str_uaktualniono_cyk_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;

                    case 1:
                        database.UpdateCyclicalExpenses(idCyclicalExpenses, txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.WEEKLY);
                        Toast.makeText(this, getResources().getString(R.string.str_uaktualniono_cyk_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;

                    case 2:
                        database.UpdateCyclicalExpenses(idCyclicalExpenses, txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.MONTHLY);
                        Toast.makeText(this, getResources().getString(R.string.str_uaktualniono_cyk_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;

                    case 3:
                        database.UpdateCyclicalExpenses(idCyclicalExpenses, txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.QUARTERLY);
                        Toast.makeText(this, getResources().getString(R.string.str_uaktualniono_cyk_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;

                    case 4:
                        database.UpdateCyclicalExpenses(idCyclicalExpenses, txtName.getText().toString(), Double.parseDouble(txtAmount.getText().toString()), CATEGORY_SELECTED_ID, SUBCATEGORY_SELECTED_ID, date1, date2, date3, Database.FREQUENCY.YEARLY);
                        Toast.makeText(this, getResources().getString(R.string.str_uaktualniono_cyk_wyd) + txtName.getText().toString(), Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        Toast.makeText(this, getResources().getString(R.string.str_blad_aktu_cykl_wyd), Toast.LENGTH_LONG).show();
                        break;
                }
            }
            intent = new Intent(this, CyclicalExpenses.class);
    ...
    public void SelectDate1(View view) {
        ...
        intent.putExtra("Class", "NewCyclicalExpenses1");
        //date3
    ...
    public void SelectDate2(View view) {
        ...
        intent.putExtra("Name", txtName.getText().toString());
        intent.putExtra("Amount", txtAmount.getText().toString());
        intent.putExtra("Class", "NewCyclicalExpenses2");
        //date3
        intent.putExtra("date1", date1);
        intent.putExtra("date2", date2);
        intent.putExtra("date3", date3);
    ...
    public void SelectDate3(View view) {
        ...
        intent.putExtra("Name", txtName.getText().toString());
        intent.putExtra("Amount", txtAmount.getText().toString());
        intent.putExtra("Class", "NewCyclicalExpenses3");
        //date3
        intent.putExtra("date1", date1);
        intent.putExtra("date2", date2);
        intent.putExtra("date3", date3);
    ...
    {
        database.RemoveCyclicalExpenses(idCyclicalExpenses);
        intent = new Intent(this, CyclicalExpenses.class);
        startActivity(intent);
    }
}
